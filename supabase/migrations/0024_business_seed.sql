...
values
 ('PROJECT-A','Project A','Entity A','Asir','active', date '2025-09-01', 64, (select id from public.profiles where role='projm')),
 ('PROJECT-B','Project B','Entity B','Riyadh','active', date '2025-10-15', 52, (select id from public.profiles where role='projm'))
...
from (values
 ('PROJECT-A','MOI-001','Police HQ — Abha','Abha','Yousef Al-Maliki','Al-Faisal HVAC','in_progress','scheduled','approved', date '2026-02-15', date '2025-11-20'),
 ('PROJECT-A','MOI-002','Civil Defense — Khamis','Khamis Mushait','Yousef Al-Maliki','Najd Technical Co.','in_progress','pending','approved', null, date '2025-12-01'),
 ('PROJECT-A','MOI-003','Traffic Dept — Bisha','Bisha','Yousef Al-Maliki','Tihama Cooling','pending','pending','awaiting', null, null),
 ('PROJECT-B','MOH-001','General Hospital — Riyadh','Riyadh','Yousef Al-Maliki','Al-Faisal HVAC','in_progress','scheduled','approved', date '2026-03-01', date '2026-01-10')
...
from (values
 ('PROJECT-A','ESM1',1),('PROJECT-A','ESM2',2),('PROJECT-A','ESM3',3),
 ('PROJECT-B','ESM1',1),('PROJECT-B','ESM3',2)
...
from (values
 ('Approve MIR — Floor 1 brackets (MOI-001)','Material inspection report for floor 1 bracket installation is awaiting PM approval.','proje','projm','PROJECT-A','MOI-001',3,'high','open'),
 ('Submit Method Statement — MOI-002','Draft and submit the installation method statement for Civil Defense Khamis.','projm','proje','PROJECT-A','MOI-002',5,'medium','in_progress'),
 ('Schedule mock-up inspection — MOI-001','Coordinate consultant mock-up sign-off visit for Police HQ Abha.','projm','proje','PROJECT-A','MOI-001',2,'medium','open'),
 ('Resolve Window 1.5 TR shortfall','Expedite procurement of the 36-unit Window 1.5 TR shortfall for Riyadh hospital.','projm','procm','PROJECT-B','MOH-001',1,'high','blocked'),
 ('Client sign-off walk-through — MOI-001','Arrange final client walk-through and sign-off for completed floors.','projm','projm','PROJECT-A','MOI-001',10,'low','open')
...
from (values
 ('Mock-up sign-off slipping beyond 7 days','Al-Faisal HVAC mock-up approval is overdue by more than seven days and is now blocking four downstream installation stages at Police HQ Abha.','PROJECT-A','MOI-001','high','open'),
 ('Window 1.5 TR shortfall of 36 units','Vendor lead time of 21 days on a 36-unit shortfall of Window 1.5 TR now threatens the Riyadh hospital delivery milestone.','PROJECT-B','MOH-001','critical','acknowledged')
...
from (values
 ('AC-S15','PROJECT-A','request',2481,'PO-2418 AC split 1.5TR programme order',30),
 ('AC-S15','PROJECT-A','receipt',1490,'DN-1124 delivery from vendor',12),
 ('LED-40W','PROJECT-A','request',17400,'Programme LED order',45),
 ('LED-40W','PROJECT-A','receipt',13572,'Partial LED delivery',10),
 ('BR-STEEL','PROJECT-A','receipt',6248,'Bracket delivery',8)
