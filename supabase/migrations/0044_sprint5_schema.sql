...
-- link PROJECT-A ESM3 installed models to the closest-capacity removed model
...
where ii.project_id = (select id from public.projects where code = 'PROJECT-A') and ii.esm_code = 'ESM3'
