-- supabase/migrations/0050_import_bundle_metadata.sql
-- Sprint 7 (Note #2.1) — the project Excel import now carries the document-default
-- fields (Project Reference No, Beneficiary Entity) so they're set once at import,
-- matching the owner's "fill once in the Excel" requirement. Same function body as
-- 0036, with the two columns added to the Project insert.
