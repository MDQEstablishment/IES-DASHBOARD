...
from (values
 ('PROJECT-A','ESM3','material_submittal','Approved'),
 ('PROJECT-A','ESM3','method_statement','Approved'),
 ('PROJECT-A','ESM3','mir','In Review'),
 ('PROJECT-A','ESM1','material_submittal','Approved'),
 ('PROJECT-A','ESM1','method_statement','In Review')
