...
function KsaMap() {
  return (
    <svg viewBox="0 0 200 200" style={{ position: 'absolute', right: -30, bottom: 40, width: 320, height: 320, opacity: 0.16 }}>
      <path d="M40 60 L120 40 L165 70 L160 120 L130 160 L80 165 L55 130 L35 95 Z" fill="none" stroke="#C29A4B" strokeWidth="1.5" />
      <circle cx="95" cy="130" r="4" fill="#B45309" />
      <circle cx="95" cy="130" r="11" fill="none" stroke="#B45309" strokeWidth="1" />
    </svg>
  )
}
...
export default function Login() {
  ...
  return (
    <div className="ies-login" style={{ position: 'fixed', inset: 0, display: 'grid', gridTemplateColumns: '1.1fr 1fr', fontFamily: 'var(--ui)' }}>
      <div className="ies-loginleft" style={{ position: 'relative', background: '#16222D', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: 48 }}>
        ...
        <div style={{ position: 'relative', display: 'flex', alignItems: 'center', gap: 12 }}>
          <div style={{ width: 40, height: 40, borderRadius: 8, background: '#1B3A53', border: '1px solid #2C4359', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'var(--mono)', fontWeight: 700, color: '#fff', fontSize: 14, letterSpacing: '.5px' }}>IES<span style={{ position: 'absolute', top: 5, right: 5, width: 6, height: 6, borderRadius: '50%', background: '#B45309' }} /></div>
          <div><div style={{ color: '#fff', fontWeight: 700, fontSize: 15 }}>Integrated Energy Solutions</div><div style={{ color: '#8A8577', fontFamily: 'var(--mono)', fontSize: 10.5, letterSpacing: '2px', marginTop: 2 }}>PROGRAMME CONTROL · RETROFIT</div></div>
        </div>
        <div style={{ position: 'relative' }}>
          <div style={{ fontFamily: 'var(--mono)', color: '#C29A4B', fontSize: 11, letterSpacing: '3px', marginBottom: 14 }}>ASIR REGION · KSA</div>
          ...
          <div style={{ color: '#A39D8E', fontSize: 14, marginTop: 16, maxWidth: 420 }}>Survey to handover. Every ESM, every building, every role — one console.</div>
        </div>
        <div style={{ position: 'relative', fontFamily: 'var(--mono)', color: '#56534B', fontSize: 11, letterSpacing: '2px' }}>BUILD 2.0</div>
      </div>
