    ...
    <div className="ies-login" style={{ position: 'fixed', inset: 0, display: 'grid', gridTemplateColumns: '1.1fr 1fr', fontFamily: 'var(--ui)' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 40, overflowY: 'auto', background: 'var(--bg)' }}>
        <div style={{ width: '100%', maxWidth: 440 }}>
          ...
          <input lang="en" value={email} onChange={(e) => setEmail(e.target.value)} style={{ width: '100%', padding: '11px 12px', border: '1px solid var(--line)', borderRadius: 8, background: '#fff', fontSize: 14, marginBottom: 14 }} />
          <label style={{ display: 'block', fontSize: 12, fontWeight: 600, color: 'var(--text-3)', marginBottom: 6 }}>Password</label>
          <input lang="en" type="password" value={pw} onChange={(e) => setPw(e.target.value)} onKeyDown={(e) => e.key === 'Enter' && manual()} style={{ width: '100%', padding: '11px 12px', border: '1px solid var(--line)', borderRadius: 8, background: '#fff', fontSize: 14, marginBottom: 16 }} />
